    ...
    constructor(props) {
        ...
        this.state={
            ...
            cols: [
                ...
                { title: (<div style={{ width: '100%' }}><span>Latitude</span><hr style={{ marginTop: '5px', marginBottom: '5px' }} /><span>Longitude</span></div>), width: '20%', removable: false, headerStyle: headerTblStyle, render: rowData => { return (<p style={{ marginBottom: '1px' }}>{rowData.Longitude}<hr />{rowData.Latitude}</p>) } },
                ...
                <div className="container-fluid" style={{ marginTop: '10%' }}>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" name="ParkingLocationName" required value={this.state.ParkingLocationName} onChange={(e) => this.setState({ ParkingLocationName: e.target.value }, () => { this.form.validateFields(e.target) })} onKeyPress={this.allowOnlyCharacters} className="form-control" placeholder="Enter Client Name" />
                    ...
                    {this.state.isFilterVisible&&
                        <div className="row" style={{ marginBottom: '1%' }} id="divFilter">
                            ...
                            <div className="col-md-3">
                                <button type="button" onClick={this.onSearchParkingLocationClick} className="btn btn-primary mt-12 mr-3">Search </button>
                                <button type="button" onClick={this.OnSearchCancelParkingLocationClick} className="btn btn-danger mt-12">Cancel </button>
                            </div>
                        </div>
                    }
                    <div className="row">
                            ...
                            <div className="card card-custom">
                                <div className="card-body">
                                    <MaterialTable columns={this.state.cols} data={this.state.data}
                                        actions={[{ icon: 'edit', tooltip: 'Edit', onClick: (e, r) => this.EditParkingLocation(r.ParkingLocationID) },
                                        { icon: 'delete', tooltip: 'Delete', onClick: (e, r) => this.CheckAlert(r.ParkingLocationID) }
                                        ]}
                                        options={{
